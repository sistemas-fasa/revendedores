<template>
  <aside class="sticky top-20 rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
    <div class="space-y-4">
      ...
      <button
        ...
        class="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-red-700 bg-red-700 px-5 py-4 text-base font-black text-white shadow-lg shadow-red-900/20 transition hover:border-red-800 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-200 disabled:cursor-not-allowed disabled:border-gray-300 disabled:bg-gray-300 disabled:text-gray-600 disabled:shadow-none"
        @click="$emit('checkout')"
      >
